...
restore_problem!(prob::AbstractBifurcationProblem, x, pars) = prob
...
apply_mass_matrix(::AbstractBifurcationProblem, x, p, dx) = dx
...
has_trivial_mass_mastrix(::AbstractBifurcationProblem) = true
