...
function continuation_from_hopf_point(br_hopf::AbstractResult{HopfCont, Tprob},
    ...
    Mass★ = has_massmatrix_adjoint(vector_field) ? getmassmatrix_adjoint(vector_field, x0, params) : adjoint(Mass)
    ...
    (; v, w) = __compute_bordered_vectors_hopf(𝐇.linbdsolver, 𝐇.linbdsolverAdjoint, Mass, Mass★, L, L★, ω, a, b, VI.zerovector(a))
