...
- `nev = 3` number of eigenvalues to be computed. It is automatically increased to have at least `nev` unstable eigenvalues. To be set for proper  bifurcation detection. See [Detection of bifurcation points of Equilibria](@ref) for more information.
...
function init(contparams::ContinuationPar{T,S,E}, 
               ::AbstractBifurcationProblem, 
               ::AbstractContinuationAlgorithm) where {T,S,E}
    return contparams
end
