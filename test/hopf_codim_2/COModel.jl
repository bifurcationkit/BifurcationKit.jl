...
@test bt.nf.K2 ≈ [-13.1155, 51.17] atol = 1e-1
@test bt.nf.d ≈ -0.1778 atol = 1e-3
@test bt.nf.e ≈ -7.1422 rtol = 1e-4
@test abs(bt.nf.a1) ≈ abs( -0.8618 ) rtol = 1e-3
@test abs(bt.nf.b1) ≈ abs( -7.1176 ) rtol = 1e-3
