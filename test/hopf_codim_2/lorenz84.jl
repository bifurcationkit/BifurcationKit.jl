...
for _jac in (BK.AutoDiff(), BK.MinAug(), BK.FiniteDifferences(), BK.MinAugMatrixBased())
    ...
    @test bpbt_2.nf.γ ≈ -1.2655376039398163 rtol = 1e-3
    @test bpbt_2.nf.c ≈ 12.35040633066114   rtol = 1e-3
    @test bpbt_2.nf.K10 ≈ [10.994145052508442, 5.261454635012957]   rtol = 1e-3
    @test bpbt_2.nf.K11 ≈ [1.4057052343089358, 0.24485405521091583] rtol = 1e-3
    @test bpbt_2.nf.K2 ≈ [2.445742562066124, 1.1704560432349538]    rtol = 1e-3
    @test bpbt_2.nf.d ≈ -0.23814643486558454 rtol = 1e-3
    @test bpbt_2.nf.e ≈ -2.8152510696740043  rtol = 1e-3
    @test bpbt_2.nf.a1 ≈ 0.588485870443459   rtol = 1e-3
    @test bpbt_2.nf.b1 ≈ 1.2381458099504048  rtol = 1e-3
    @test bpbt_2.nf.H0001 ≈ [1.2666466468447481, -0.11791034083511988, -0.26313225842609955, -0.5338271838915466] rtol = 1e-3
    @test bpbt_2.nf.H0010 ≈ [15.651509120793042, -1.1750214928055762, -3.2016608356146423, -6.424103770005164]    rtol = 1e-3
    @test bpbt_2.nf.H0002 ≈ [-0.34426541029040103, 0.7403628764888541, 0.5020796040084594, 0.7211107457956355]    rtol = 1e-3
    @test bpbt_2.nf.H1001 ≈ [0.8609019479520158, 0.3666091456682787, 0.09272126477464948, -1.1252591151814477]    rtol = 1e-3
    @test bpbt_2.nf.H2000 ≈ [-1.1430891994241816, 0.5090981254844374, 0.4300904962638521, -0.4240003230561569]    rtol = 1e-3
