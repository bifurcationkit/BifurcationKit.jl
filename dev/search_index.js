...
{
    "location": "library/#PseudoArcLengthContinuation.newtonDeflated-Union{Tuple{vectype}, Tuple{Tf}, Tuple{T}, Tuple{Any,Any,vectype,NewtonPar{T,S,E} where E<:EigenSolver where S<:AbstractLinearSolver,DeflationOperator{T,Tf,vectype}}} where vectype where Tf where T",
    "page": "Library",
