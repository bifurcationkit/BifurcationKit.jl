...

{
    ...
    "category": "section",
    "text": "We were inspired by pde2path. One can also mention the venerable AUTO, or also, MATCONT or Trilinos. Most continuation softwares are listed on DSWeb.One design choice is that we try not to require u to be a subtype of an AbstractArray as this would forbid the use of spectral methods (like the one from ApproxFun.jl) or some GPU package, e.g. ArrayFire.jl. So far, our implementation does not allow this for Fold / Hopf continuation and computation of periodic orbits. It will be improved later."
},
...

{
    ...
    "category": "section",
    "text": "One a Hopf point have been detected after a call to br, _ = continuation(...), it can be refined with the use of newton iterations. Several method have been implemented but we focus on the Minimally Augmented one. A simplified interface is provided for the use of this method."
},
...

{
    ...
    "title": "Functions",
    "category": "section",
    "text": "newtonFoldnewtonHopfcontinuationFoldcontinuationHopf"
},
